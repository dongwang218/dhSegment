...
def run(train_data, eval_data, model_output_dir, gpu, training_params, _config):
    ...
    exporter = tf.estimator.LatestExporter('myexporter', serving_input_receiver_fn=serving_input_fn, exports_to_keep=2)

    exported = exporter.export(estimator, saved_model_dir, checkpoint_path=None, eval_result=None,
